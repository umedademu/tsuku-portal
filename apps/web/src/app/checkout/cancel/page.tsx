...
export const metadata: Metadata = {
  ...
  description:
    "Stripeの決済を完了できませんでした。プランを選び直して再度お試しください。決済完了後の反映は次のステップで接続します。",
};
      ...
      <header className="plan-hero">
        <div className="container">
          ...
          <p className="plan-hero-lead">
            Stripe上で手続きが完了しませんでした。カード情報を再入力する場合はプランを選び直して「決済へ進む」を押してください。
          </p>
          ...
          <div className="plan-summary">
            <div>
              ...
              <p className="plan-summary-note">
                決済完了後の状態反映は次のステップで接続予定です。まずはStripeでの手続きを完了させてください。
              </p>
            </div>
